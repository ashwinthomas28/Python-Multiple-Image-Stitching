...
This repository contains an implementation of multiple image stitching. For explanation you could refer to my blog post : [Creating a panorama using multiple images](http://kushalvyas.github.io/stitching.html)
